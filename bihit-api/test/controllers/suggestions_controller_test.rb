...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { date_created: @suggestion.date_created, title: @suggestion.title, user_id: @suggestion.user_id } }, as: :json
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { date_created: @suggestion.date_created, title: @suggestion.title, user_id: @suggestion.user_id } }, as: :json
    assert_response 200
  end
